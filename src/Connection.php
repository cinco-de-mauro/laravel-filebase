...
use LaravelFilebase\Filebase\Client;
use LaravelFilebase\Illuminate\Eloquent\Builder;
use Filebase\Query;
...
class Connection extends BaseConnection
{
    ...
    {
        $this->db = $this->initDatabaseClient($config);
    }
    ...
    {
        $query = new Builder($this, $this->getDefaultQueryGrammar(), $this->getDefaultPostProcessor());
     ...
     * @param array $config
     * @return Filebase\Client
     * @throws \Filebase\Filesystem\FilesystemException
     */
    protected function initDatabaseClient(array $config)
    {
        $default = [
